...
$config['samlauth.authentication']['sp_entity_id'] = 'https://datasupport.docker.so';
$config['samlauth.authentication']['sp_cert_folder'] = '/app/conf/samlauth';
$config['samlauth.authentication']['idp_entity_id'] = 'https://idp-datasupport.docker.so/simplesaml/saml2/idp/metadata.php';
$config['samlauth.authentication']['idp_single_sign_on_service'] = 'https://idp-datasupport.docker.so/simplesaml/saml2/idp/SSOService.php';
$config['samlauth.authentication']['idp_single_log_out_service'] = 'https://idp-datasupport.docker.so/simplesaml/saml2/idp/SingleLogoutService.php';
